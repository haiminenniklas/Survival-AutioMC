...
public class Boosters implements Listener {
    ...
    public enum Booster {
        ...
        MORE_ORES(30, "§bMineeralimyllerrys!",
                "§7Kun tämä tehostus on päällä, niin §bTimantti§7, §aEmerald§7, §9Lapis §7-malmeista tippuu §a2x §7enemmän tavaraa millä tahansa työkalulla! Tehostus kestää §6§l30MIN§7!", 3750, () -> {
        }, Material.DIAMOND_ORE),
        EXTRA_HEARTS(60, "§cSote-uudistus",
                "§7Kun tämä tehostus on päällä, sinulla on §c2 lisäsydäntä§7! Tehostus kestää §6§l1H§7!", 450, () -> {
        ...
        FIX_ITEMS(-1, "§fSepän armahdus",
                "§7Tämä korjaa kaikki inventoryssasi olevat itemit.", 8000, () -> {
        ...
        NO_HUNGER(60, "§6Leipäjono",
                "§7Tällä tehostuksella et koe nälkää! Tehostus kestää §6§l1H§7!", 600, () -> {
        }, Material.COOKED_BEEF),

        DOUBLE_XP(45, "§eKokemuspisteiden kapina",
                "§7Tällä tehostuksella saat jokaisesta tappamastasi mobista §a2x §7enemmän §eXP:§7tä! Tehostus kestää §6§l45MIN§7!", 1250, () -> {
